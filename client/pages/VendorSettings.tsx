    ...
    <VendorLayout activeTab="settings">
      <div className="space-y-6 max-w-2xl">
        <div>
          ...
          <p className="text-muted-foreground">Store details, policies, and preferences.</p>
        </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <FormField name="enableCod" control={form.control} render={({ field }) => (
                  ...
                  <FormField name="enableReturns" control={form.control} render={({ field }) => (
                    <FormItem className="flex items-center justify-between rounded-lg border p-3">
