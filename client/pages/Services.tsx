...
const quoteSchema = z.object({
  ...
  budget: z
    .string()
    .optional()
    .transform((v) => (v && v.trim() !== "" ? Number(v.replace(/[^0-9]/g, "")) : undefined))
    .refine((v) => v === undefined || v >= 0, { message: "Budget must be positive" }),
...
export default function Services() {
  ...
  const form = useForm<z.infer<typeof quoteSchema>>({
    ...
    defaultValues: { name: "", email: "", phone: "", company: "", service: "", budget: "" as unknown as string, message: "" },
    mode: "onBlur",
  });
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-1">
          <CardHeader>
            ...
            <CardDescription>Tell us what you need. We’ll tailor a plan for you.</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <FormField name="budget" control={form.control} render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder={`${formatPrice(25000)} e.g.`} {...field} />
                      </FormControl>
                      <FormDescription>Enter an amount in ₹ (optional)</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )} />
                </div>
                <FormField name="message" control={form.control} render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea rows={5} placeholder="Tell us about your goals, timelines, and any links." {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
